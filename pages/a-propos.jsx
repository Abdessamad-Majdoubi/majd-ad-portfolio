...
export default function AProposDeMoi(props) {
	...
	useEffect(() => {
		async function fetchGithubStats() {
			const response = await fetch("https://api.github.com/users/Abdessamad-Majdoubi");
					...
					<div className="left-view">
						<ScrollAnimation animateIn="fadeIn" animateOnce delay={200}>
							<GithubStatsCard>
								...
								<div className="img">
									<Image src="/img/unnamed.png" alt={language.aboutMePage.alt_dev_img} layout="fill" objectFit="cover" className="image-rounded" />
								</div>
					...
					<div className="right-view">
						<ScrollAnimation animateIn="fadeIn" animateOnce delay={200}>
							...
							<div className="tech-and-cv">
								...
								<ButtonCV href="https://majd-ad.tiiny.site/" target="_blank" data-splitbee-event="Download CV">
									Download CV
								</ButtonCV>
							</div>
						</ScrollAnimation>
